...
@section('header_title', 'Master Data — Buat Kuis Baru')
...
<div class="md-page-header mb-4">
    <div class="md-page-title">
        ...
        <div>
            <h5 class="md-title">Buat Kuis Baru</h5>
        </div>
    </div>
...
<div class="md-form-card">
    <div class="md-form-head">
        ...
        <h6 class="md-form-head-title mb-0">Informasi Pengaturan Kuis</h6>
    </div>
    ...
    <form action="{{ route('admin.quizzes.store') }}" method="POST">
        ...
        <div class="md-form-footer">
            ...
            <button type="submit" class="md-btn-submit">
                <i class="ti ti-arrow-right"></i> Simpan &amp; Kelola Soal
            </button>
        </div>
    </form>
</div>
