...
@section('header_title', 'Master Data — Edit Tugas Siswa')
...
<div class="col-md-12">
    ...
    <div class="md-page-header mb-4">
        <div class="md-page-title">
            ...
            <div>
                <h5 class="md-title">Edit Tugas Siswa</h5>
            </div>
        </div>
        ...
        <form action="{{ route('admin.assignments.update', $assignment) }}" method="POST">
            ...
            <div class="md-form-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title', $assignment->title) }}" required placeholder="Contoh: Tugas Mandiri Bab 1 Aljabar">
                    @error('title')
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control tinymce @error('description') is-invalid @enderror" id="description" name="description" rows="6" placeholder="Tuliskan petunjuk atau rincian soal tugas di sini...">{{ old('description', $assignment->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
