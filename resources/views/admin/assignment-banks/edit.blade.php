...
@section('header_title', 'Master Data — Edit Bank Tugas')
...
<div class="md-page-header mb-4">
    <div class="md-page-title">
        ...
        <div>
            <h5 class="md-title">Edit Master Tugas</h5>
        </div>
    </div>
...
<div class="md-form-card">
    <div class="md-form-head">
        ...
        <h6 class="md-form-head-title mb-0">Edit Informasi Master Bank Tugas</h6>
    </div>

    <form action="{{ route('admin.assignment-banks.update', $assignmentBank) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="md-form-body">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title', $assignmentBank->title) }}" required placeholder="Misal: Tugas Proyek Pemrograman Laravel Rest API">
                @error('title')
            ...
            <div class="mb-4">
                ...
                <select class="form-select select2 @error('subject_id') is-invalid @enderror" id="subject_id" name="subject_id">
                    ...
                    @foreach($subjects as $subject)
                        <option value="{{ $subject->id }}" {{ old('subject_id', $assignmentBank->subject_id) == $subject->id ? 'selected' : '' }}>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control tinymce @error('description') is-invalid @enderror" id="description" name="description" rows="6" placeholder="Tuliskan instruksi tugas secara rinci di sini...">{{ old('description', $assignmentBank->description) }}</textarea>
                @error('description')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="md-form-footer">
            ...
            <button type="submit" class="md-btn-submit">
                <i class="ti ti-device-floppy"></i> Perbarui Master Tugas
            </button>
        </div>
    </form>
</div>
