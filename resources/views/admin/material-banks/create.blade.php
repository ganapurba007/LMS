...
@section('header_title', 'Master Data — Tambah Bank Materi')
...
<div class="md-page-header mb-4">
    <div class="md-page-title">
        ...
        <div>
            <h5 class="md-title">Tambah Master Materi</h5>
        </div>
    </div>
...
<div class="md-form-card">
    ...
    <form action="{{ route('admin.material-banks.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="md-form-body">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title') }}" required placeholder="Misal: Modul Pembelajaran Pemrograman Web Lanjut">
                @error('title')
            ...
            <div class="p-3 mb-4 rounded-3" style="background:var(--tblr-body-bg,#f8fafc);border:1px solid var(--tblr-border-color,#e2e8f0);">
                ...
                <!-- Teks / Artikel -->
                <div class="mb-3">
                    <label class="md-form-label">Teks / Artikel Artikel Materi</label>
                    <textarea class="form-control tinymce @error('content') is-invalid @enderror" id="content" name="content" rows="6" placeholder="Tuliskan isi materi master di sini...">{{ old('content') }}</textarea>
                    @error('content')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="md-form-hint text-white">Format didukung: PDF, DOCX, PPTX, XLSX, PNG, JPG, ZIP, RAR.</div>
                        @error('document_file')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
        ...
        <div class="md-form-footer">
            ...
            <button type="submit" class="md-btn-submit">
                <i class="ti ti-device-floppy"></i> Simpan Master Materi
            </button>
        </div>
    </form>
</div>
